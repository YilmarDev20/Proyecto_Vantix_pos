...
export const CategoryFilters = ({ searchTerm, onSearchChange, statusFilter, onStatusChange }: any) => {
  return (
    <div className="bg-slate-50 dark:bg-slate-950/40 p-4 border-b border-slate-100 dark:border-slate-800 flex flex-col md:flex-row gap-4 transition-colors">
